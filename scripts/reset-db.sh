...
#
# Configuration is insert-only policy history, not board data, so a normal reset
# deliberately keeps issuing_config v1. Runtime tables are listed children first.
TABLES="card_status_history card_record"
