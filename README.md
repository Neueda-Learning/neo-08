...
that role can only touch this repo's own `neobank-<env>-neo-08` stack. You never hold AWS
credentials yourself — everything that reaches AWS goes through a workflow in this repo.

The front-end image is built with `APP_BASE_PATH=/neo-08`, because in the deployed stack
...
|---|---|---|---|
| **dev** | [`/neo-08/`](http://neobank-dev-571740187.ap-southeast-1.elb.amazonaws.com/neo-08/) | [`/neo-08/health`](http://neobank-dev-571740187.ap-southeast-1.elb.amazonaws.com/neo-08/health) · [`/neo-08/info`](http://neobank-dev-571740187.ap-southeast-1.elb.amazonaws.com/neo-08/info) | [orchestrator](http://neobank-dev-571740187.ap-southeast-1.elb.amazonaws.com/) |
| **prod** | [`/neo-08/`](http://neobank-prod-294820685.ap-southeast-1.elb.amazonaws.com/neo-08/) | [`/neo-08/health`](http://neobank-prod-294820685.ap-southeast-1.elb.amazonaws.com/neo-08/health) · [`/neo-08/info`](http://neobank-prod-294820685.ap-southeast-1.elb.amazonaws.com/neo-08/info) | [orchestrator](http://neobank-prod-294820685.ap-southeast-1.elb.amazonaws.com/) |
...
A `reset` destroys **only this service's schema** (`neo_08`). Every other service and the
...
- `backend/` and `frontend/` **stay at the repo root** — the system compose builds
  `./neo-08/backend` and `./neo-08/frontend` by path.
